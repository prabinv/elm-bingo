...
Elm.Bingo.make = function (_elm) {
   ...
   _L.fromArray([$Html$Attributes.href("http://www.volusion.com")]),
   _L.fromArray([$Html.text("Volusion")]))]));
